...
<div class="position-relative bg-img-start"
	...
	<div class="container content-space-t-3 content-space-t-lg-5 content-space-b-2 position-relative zi-2">
		<div class="w-md-75 w-lg-75 text-center mx-md-auto mb-5 mb-md-9">
			...
			<p class="h4 fw-normal">You can call us on this number if you had anything that you need to ask</p>
		</div>
			...
			<div class="col-md-4">
				...
				<a class="card card-transition text-center h-100" href="#">
					<div class="card-body">
						...
						<p class="card-text text-body"><?= $web_telepon;?></p>
					</div>

					<div class="card-footer pt-0">
						<span class="card-link"
							onclick="window.location.href=`https://wa.me/<?= $web_telepon;?>?text=I'm%20interested%20to%20become%20YBB%20Contributor`">Contact us
