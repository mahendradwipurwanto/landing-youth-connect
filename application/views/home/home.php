...
<!-- Card Grid -->
<div class="position-relative" style="background: url(<?= base_url(); ?>assets/svg/components/abstract-shapes-19.svg) center no-repeat;">
		...
		<div class="row mt-5">
			...
			<div class="col-md-3">
				...
				<div class="text-center px-lg-3">
					...
					<p>istanbulyouthsummit@gmail.com <br>&<br>admin@ybbfoundation.com</p>
				</div>
				<!-- End Icon Blocks -->
			</div>
			<!-- End Col -->
			...
			<div class="col-sm-12 col-md-10 col-lg-10 mb-3 mb-md-5 mb-lg-7">
				<div class="box-video">
					<div class="video-container">
						<iframe src="https://www.youtube.com/embed/o254-8BPCqg?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen="allowfullscreen"></iframe>
					</div>
				</div>
			</div>
		</div>
...
<div class="position-relative" style="background: url(<?= base_url(); ?>assets/svg/components/abstract-shapes-9.svg) center no-repeat;">
		...
		<div class="row justify-content-lg-center">
			<div class="col-md-6 col-lg-5 mb-3 mb-md-5 mb-lg-7">
				...
				<div class="d-flex pe-md-5">
					...
					<div class="flex-grow-1 ms-3">
						<h4>What is IYS ?</h4>
						<p style="text-align: justify;">IYS 2024 is the seventh international summit organized by Youth Break the Boundaries (YBB) Foundation in Istanbul. This summit will encourage future leaders who break the boundaries of their abilities to discuss and take action in <b>Innovation and Collaboration: Unlocking Youth-driven Solutions for Sustainability</b>. With this themes, IYS 2024 also encourages young people from all backgrounds and sectors to collaborate together and utilize their leadership capabilities in helping and realizing to make sustainable development goals become achievable.</p>
					</div>
				</div>
				<!-- End Icon Blocks -->
			</div>
			...
			<div class="col-md-6 col-lg-5 mb-3 mb-md-5 mb-lg-7">
				...
				<div class="d-flex ps-md-5">
					...
					<div class="flex-grow-1 ms-3">
						<h4>Why you join?</h4>
						<p style="text-align: justify;">The delegates should participate in the Istanbul Youth Summit to engage in meaningful discussions on global challenges, foster cross-cultural understanding, and collaborate with young leaders from around the world to create positive change. This summit offers a unique opportunity to develop leadership skills, gain valuable insights, and contribute to shaping a more inclusive and sustainable future.</p>
					</div>
				</div>
				<!-- End Icon Blocks -->
			</div>
			...
			<div class="col-md-6 col-lg-5">
				...
				<div class="d-flex pe-md-5">
					...
					<div class="flex-grow-1 ms-3">
						...
						<p style="text-align: justify;">The program will intend to achieve five main goals. We aim to cultivate the spirit of talented youth leaders across diverse fields, foster and nurture the character of youth leadership, establish a strong presence for youth on the international stage, develop the leadership capabilities of youth, empowering them to actively contribute to their country's development, create a robust network and lasting connections among IYS alumni to ensure the continuity of the Istanbul Youth Summit program for years to come.</p>
			...
			<div class="col-md-6 col-lg-5 mb-3 mb-md-5 mb-lg-7">
				...
				<div class="d-flex ps-md-5">
					...
					<div class="flex-grow-1 ms-3">
						<h4>IYS Agenda</h4>
						<p style="text-align: justify;">This Istanbul Youth Summit (IYS) activity will be held on March 4 – 7, 2023 in Istanbul, Türkiye.</p>
					</div>
				</div>
				<!-- End Icon Blocks -->
			</div>
...
<div class="bg-dark rounded-2" style="background-image: url(<?= base_url(); ?>assets/svg/components/wave-pattern-light.svg);">
		...
		<ul class="step step-timeline-md">
			<li class="step-item">
				<div class="step-content-wrapper">
					...
					<div class="step-content">
						<h4 class="text-white">August 7-September 10, 2023</h4>

						<p class="step-text text-white-70">Participant Registration</p>
					</div>
				</div>
			</li>
			...
			<li class="step-item">
				<div class="step-content-wrapper">
					...
					<div class="step-content">
						<h4 class="text-white">September 15 - 30, 2023</h4>
			...
			<li class="step-item">
				<div class="step-content-wrapper">
					...
					<div class="step-content">
						<h4 class="text-white">October 1-31, 2023</h4>
						<p class="step-text text-white-70">Payment Batch 1</p>
					</div>
				</div>
			</li>
			...
			<li class="step-item">
				<div class="step-content-wrapper">
					...
					<div class="step-content">
						<h4 class="text-white">November 5-10, 2023</h4>
						<p class="step-text text-white-70">Interview Announcement for Fully Funded Participants</p>
					</div>
				</div>
			</li>
			...
			<li class="step-item">
				<div class="step-content-wrapper">
					...
					<div class="step-content">
						<h4 class="text-white">November 11-15, 2023</h4>
						<p class="step-text text-white-70">Fully Funded Interview</p>
					</div>
				</div>
			</li>
			...
			<li class="step-item">
				<div class="step-content-wrapper">
					...
					<div class="step-content">
						<h4 class="text-white">November 1-30, 2023</h4>
						<p class="step-text text-white-70">Payment Batch 2</p>
					</div>
				</div>
			</li>
			...
			<li class="step-item">
				<div class="step-content-wrapper">
					<span class="step-icon step-icon-soft-light">7</span>
					<div class="step-content">
						<h4 class="text-white">December 11-15, 2023</h4>
						<p class="step-text text-white-70">Final Announcement for Fully Funded Participants</p>
					</div>
				</div>
			</li>
			...
			<li class="step-item">
				<div class="step-content-wrapper">
					<span class="step-icon step-icon-soft-light">8</span>
					<div class="step-content">
						<h4 class="text-white">December 2023 to February 2024</h4>
						<p class="step-text text-white-70">Mentoring Session</p>
					</div>
				</div>
			</li>
			...
			<li class="step-item">
				<div class="step-content-wrapper">
					<span class="step-icon step-icon-soft-light">9</span>
					<div class="step-content">
						<h4 class="text-white">March 4-7, 2024</h4>
						<p class="step-text text-white-70">Istanbull Youth Summit 2024</p>
					</div>
				</div>
			</li>
		</ul>
			...
			<div class="card bg-primary h-100 overflow-hidden">
				<div class="card-body">
					<div class="w-65 pe-2">
						...
						<a class="btn btn-light btn-sm btn-transition" href="<?= prep_url($web_guidelines); ?>" target="_blank">Download <i class="bi-chevron-right small ms-1"></i></a>
					</div>

					<div style="width: 300px; right: 10px; top: 10px;" class="position-absolute">
						<img class="card-img" src="<?= base_url(); ?>assets/svg/illustrations/add-file.svg" alt="Image Description">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="js-shuffle row row-cols-1 row-cols-sm-2 row-cols-md-3">
			...
			<div class="js-shuffle-item col mb-5" data-groups='["iys"]'>
				...
				<a class="card card-flush card-transition" href="#">
					<img class="card-img-top lazy" style="object-fit: cover;height: 250px;" data-src="<?= site_url('') ?>assets/images/landing/2021_1.JPG" alt="Image Description">
					<div class="card-body">
			...
			<div class="js-shuffle-item col mb-5" data-groups='["iys"]'>
				<!-- Card -->
				<a class="card card-flush card-transition" href="#">
					<img class="card-img-top lazy" style="object-fit: cover;height: 250px;" data-src="<?= site_url('') ?>assets/images/landing/2021_2.JPG" alt="Image Description">
					<div class="card-body">
						<span class="card-subtitle text-body">Istanbul Youth Summit</span>
						<!-- <h3 class="card-title">Lorem Ipsum</h3> -->
					</div>
			...
			<div class="js-shuffle-item col mb-5" data-groups='["iys"]'>
				<!-- Card -->
				<a class="card card-flush card-transition" href="#">
					<img class="card-img-top lazy" style="object-fit: cover;height: 250px;" data-src="<?= site_url('') ?>assets/images/landing/2021_3.JPG" alt="Image Description">
					<div class="card-body">
						<span class="card-subtitle text-body">Istanbul Youth Summit</span>
						<!-- <h3 class="card-title">Lorem Ipsum</h3> -->
					</div>
			...
			<div class="js-shuffle-item col mb-5" data-groups='["iys"]'>
				<!-- Card -->
				<a class="card card-flush card-transition" href="#">
					<img class="card-img-top lazy" style="object-fit: cover;height: 250px;" data-src="<?= site_url('') ?>assets/images/landing/2020_1.JPG" alt="Image Description">
					<div class="card-body">
						<span class="card-subtitle text-body">Istanbul Youth Summit</span>
						<!-- <h3 class="card-title">Lorem Ipsum</h3> -->
					</div>
			...
			<div class="js-shuffle-item col mb-5" data-groups='["iys"]'>
				<!-- Card -->
				<a class="card card-flush card-transition" href="#">
					<img class="card-img-top lazy" style="object-fit: cover;height: 250px;" data-src="<?= site_url('') ?>assets/images/landing/2020_2.JPG" alt="Image Description">
					<div class="card-body">
						<span class="card-subtitle text-body">Istanbul Youth Summit</span>
						<!-- <h3 class="card-title">Lorem Ipsum</h3> -->
					</div>
			...
			<div class="js-shuffle-item col mb-5" data-groups='["iys"]'>
				<!-- Card -->
				<a class="card card-flush card-transition" href="#">
					<img class="card-img-top lazy" style="object-fit: cover;height: 250px;" data-src="<?= site_url('') ?>assets/images/landing/2020_3.JPG" alt="Image Description">
					<div class="card-body">
						<span class="card-subtitle text-body">Istanbul Youth Summit</span>
						<!-- <h3 class="card-title">Lorem Ipsum</h3> -->
					</div>
			...
			<div class="js-shuffle-item col mb-5" data-groups='["kls"]'>
				<!-- Card -->
				<a class="card card-flush card-transition" href="#">
					<img class="card-img-top lazy" style="object-fit: cover;height: 250px;" data-src="<?= site_url('') ?>assets/images/landing/ksl1.jpg" alt="Image Description">
					<div class="card-body">
			...
			<div class="js-shuffle-item col mb-5" data-groups='["kls"]'>
				<!-- Card -->
				<a class="card card-flush card-transition" href="#">
					<img class="card-img-top lazy" style="object-fit: cover;height: 250px;" data-src="<?= site_url('') ?>assets/images/landing/ksl2.jpg" alt="Image Description">
					<div class="card-body">
						<span class="card-subtitle text-body">Kuala Lumpur Summit</span>
						<!-- <h3 class="card-title">Lorem Ipsum</h3> -->
					</div>
			...
			<div class="js-shuffle-item col mb-5" data-groups='["kls"]'>
				<!-- Card -->
				<a class="card card-flush card-transition" href="#">
					<img class="card-img-top lazy" style="object-fit: cover;height: 250px;" data-src="<?= site_url('') ?>assets/images/landing/ksl3.jpg" alt="Image Description">
					<div class="card-body">
						<span class="card-subtitle text-body">Kuala Lumpur Summit</span>
						<!-- <h3 class="card-title">Lorem Ipsum</h3> -->
					</div>
			...
			<div class="js-shuffle-item col mb-5" data-groups='["kls"]'>
				<!-- Card -->
				<a class="card card-flush card-transition" href="#">
					<img class="card-img-top lazy" style="object-fit: cover;height: 250px;" data-src="<?= site_url('') ?>assets/images/landing/ksl4.jpg" alt="Image Description">
					<div class="card-body">
						<span class="card-subtitle text-body">Kuala Lumpur Summit</span>
						<!-- <h3 class="card-title">Lorem Ipsum</h3> -->
					</div>
			...
			<div class="js-shuffle-item col mb-5" data-groups='["kls"]'>
				<!-- Card -->
				<a class="card card-flush card-transition" href="#">
					<img class="card-img-top lazy" style="object-fit: cover;height: 250px;" data-src="<?= site_url('') ?>assets/images/landing/ksl5.jpg" alt="Image Description">
					<div class="card-body">
						<span class="card-subtitle text-body">Kuala Lumpur Summit</span>
						<!-- <h3 class="card-title">Lorem Ipsum</h3> -->
					</div>
			...
			<div class="js-shuffle-item col mb-5" data-groups='["kls"]'>
				<!-- Card -->
				<a class="card card-flush card-transition" href="#">
					<img class="card-img-top lazy" style="object-fit: cover;height: 250px;" data-src="<?= site_url('') ?>assets/images/landing/ksl6.jpg" alt="Image Description">
					<div class="card-body">
						<span class="card-subtitle text-body">Kuala Lumpur Summit</span>
						<!-- <h3 class="card-title">Lorem Ipsum</h3> -->
					</div>
				...
				<div class="position-relative">
					...
					<div class="position-absolute bottom-0 start-0 w-100" style="max-width: 7rem;">
						<div class="mb-n7 ms-n7">
							<img class="img-fluid" src="<?= base_url(); ?>assets/svg/components/dots.svg" alt="Image Description">
						</div>
					</div>
					<!-- End SVG Shape -->
				</div>
